...
import { coldrooms } from './ColdRooms';
import { blastcoolers } from './BlastCoolers';
import { humidity } from './HighHumidity';
import { packhouses } from './PackHouses';
import { monitoring } from './TemperatureMonitoring';
...
const list = [
  ...
  { text: 'solar refrigeration systems', url: ''},
];
